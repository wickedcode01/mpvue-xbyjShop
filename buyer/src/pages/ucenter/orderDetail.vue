    ...
    <view class="container">
        <view class="order-info">
            ...
            <view class="item-c">
                ...
                <view class="r">
                    <view class="btn" @click="cancelOrder" v-if="handleOption.cancel">取消订单</view>
                    <view class="btn active" @click="payOrder" v-if="handleOption.pay">去付款</view>
                </view>
            </view>
        </view>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            async payOrder() {
                let that = this;
                const res = await api.PayPrepayIdFunc({
            ...
            async cancelOrder() {
             let id=this.orderId;
                wx.showModal({
                    ...
                    success(res) {
                        if (res.confirm) {
                            api.OrderCancel({orderId:id}).then(function(res){
                                console.log(200);
                            }).catch(function(err){
                                console.log(500+err);
                            }) ;
